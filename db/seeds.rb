...
Planet.create(name: 'Naboo', description: 'Temperate, dry, and fairly pleasant.', weather: 'Clear', temperature_min: 5, temperature_max: 25, background: 'https://static.wikia.nocookie.net/starwars/images/e/eb/Theedroyalpalace.png')
