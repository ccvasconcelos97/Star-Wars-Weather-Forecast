...
Planet.create(name: 'Hoth', description: 'Cold, ice, freezing desolation.', weather: nil, temperature_min: -100, temperature_max: -1, background: 'hoth.jpg', source: 'https://www.artstation.com/artwork/gRD5Z')
Planet.create(name: 'Naboo', description: 'Temperate, dry, and fairly pleasant.', weather: 'Clear', temperature_min: 5, temperature_max: 25, background: 'naboo.jpg', source: 'https://www.artstation.com/artwork/Prrn8')
Planet.create(name: 'Tatooine', description: 'Hot, dry, occasional sarlacc.', weather: 'Clear', temperature_min: 20, temperature_max: 100, background: 'tatooine.jpg', source: 'https://www.artstation.com/artwork/KyP19')
