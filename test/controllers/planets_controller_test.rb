...
class PlanetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create planet" do
    assert_difference('Planet.count') do
      post planets_url, params: { planet: { description: @planet.description, name: @planet.name, temperature_max: @planet.temperature_max, temperature_min: @planet.temperature_min, weather: @planet.weather } }
    end
  ...
  test "should update planet" do
    patch planet_url(@planet), params: { planet: { description: @planet.description, name: @planet.name, temperature_max: @planet.temperature_max, temperature_min: @planet.temperature_min, weather: @planet.weather } }
